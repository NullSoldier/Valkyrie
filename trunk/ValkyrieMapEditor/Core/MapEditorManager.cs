...
namespace ValkyrieMapEditor
{
    public static class MapEditorManager
	{
		...
		{
			get { return MapEditorManager.currentmap; }
		}
		...
		//public static IEngineContext Context = null;
		...
		//public static List<Assembly> EventAssemblies = new List<Assembly>();
		...
		//    return provider.GetMap(location, );
		...
		//public static int GetTileSetValue (MapPoint point)
		//{
